...
namespace DAL.Migrations
{
    ...
    {
        /// <summary>
        /// Configures the Entity Framework Core model to represent the migration's target database schema (migration snapshot).
        /// </summary>
        /// <param name="modelBuilder">The ModelBuilder used to define entity types, properties, indexes, relationships, and annotations for the target model.</param>
