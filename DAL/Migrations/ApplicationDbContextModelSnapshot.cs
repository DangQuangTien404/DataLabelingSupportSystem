...
namespace DAL.Migrations
{
    ...
    {
        /// <summary>
        /// Configures the Entity Framework Core model for the migration snapshot.
        /// </summary>
        /// <remarks>
        /// Defines model-wide annotations and configures all entities, their properties (types, nullability, precision),
        /// primary keys, indexes, table mappings, and relationships (foreign keys and delete behaviors) to reproduce the
        /// database schema for migrations.
        /// </remarks>
        /// <param name="modelBuilder">The ModelBuilder used to construct the model for the snapshot.</param>
